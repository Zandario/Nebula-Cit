...
*/
/obj/item/uplink/ui_interact(mob/user, ui_key = "main", datum/nanoui/ui, force_open = TRUE, var/uistate = global.inventory_topic_state)
	...
	if (!ui)	// No auto-refresh
		ui = new(user, src, ui_key, "uplink", title, 450, 600, state = uistate)
...
/obj/item/uplink/contained/ui_interact(mob/user, ui_key = "main", datum/nanoui/ui, force_open = TRUE, var/uistate = global.contained_topic_state)
	return ..()
