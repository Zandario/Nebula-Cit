...
/obj/machinery/lapvend/ui_interact(mob/user, ui_key = "main", datum/nanoui/ui, force_open = TRUE)
	...
	if (!ui)
		ui = new(user, src, ui_key, "computer_fabricator", "Personal Computer Vendor", 500, 400)
