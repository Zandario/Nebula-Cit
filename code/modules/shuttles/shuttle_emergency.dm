...
/obj/machinery/computer/shuttle_control/emergency/ui_interact(mob/user, ui_key = "main", datum/nanoui/ui, force_open = TRUE)
	var/data[0]
	...
	if (!ui)
		ui = new(user, src, ui_key, "escape_shuttle_control_console", "Shuttle Control", 470, 420)
