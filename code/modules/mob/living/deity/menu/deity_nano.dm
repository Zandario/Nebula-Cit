...
/mob/living/deity/ui_interact(mob/user, ui_key = "main", datum/nanoui/ui, force_open = TRUE, var/uistate = global.self_topic_state)
	...
	if(!ui)
		ui = new(user, src, ui_key, "deity", "Deity Menu", 650, 600, state = uistate)
