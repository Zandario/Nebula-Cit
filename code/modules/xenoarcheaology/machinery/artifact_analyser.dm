...
/obj/machinery/artifact_analyser/ui_interact(mob/user, ui_key = "main", datum/nanoui/ui, force_open = TRUE)
	var/data[0]
	...
	if (!ui)
		ui = new(user, src, ui_key, "anomaly_scanner", "Anomaly Analyzer Console", 360, 500)
