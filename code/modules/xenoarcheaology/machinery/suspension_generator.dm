...
/obj/machinery/suspension_gen/ui_interact(mob/user, ui_key = "main", datum/nanoui/ui, force_open = TRUE)
	var/data[0]
	...
	if (!ui)
		ui = new(user, src, ui_key, "suspension_gen", "Suspension Field Generator", 400, 190)
