...
/obj/item/anodevice/ui_interact(mob/user, ui_key = "main", datum/nanoui/ui, force_open = TRUE)
	var/data[0]
	...
	if (!ui)
		ui = new(user, src, ui_key, "anomaly_battery_device", "Anomaly Power Utiliser", 390, 500)
