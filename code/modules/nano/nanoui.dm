 ...
 * @param ntemplate string The filename of the template file from /nano/templates (e.g. "my_template")
 ...
 */
/datum/nanoui/New(nuser, nsrc_object, nui_key, ntemplate_filename, ntitle = 0, nwidth = 0, nheight = 0, datum/nref, datum/nanoui/master_ui, datum/topic_state/state = global.default_topic_state)
	user = nuser
 ...
 * @param filename {string} The name of the template file from /nano/templates (e.g. "my_template")
 * @param filetype {string} The file type of the template file (e.g. ".njk")
 *
 * @return nothing
 */
/datum/nanoui/proc/add_template(key, filename, filetype = ".njk")
	templates[key] = filename + filetype
 ...
 *     -> a template in /nano/templates with the filename "layout_<layout_key>.njk
...
/datum/nanoui/proc/get_html()
	...
	add_template("layout", "layout_[layout_key]")
	if (layout_header_key)
		add_template("layoutHeader", "layout_[layout_header_key]")
