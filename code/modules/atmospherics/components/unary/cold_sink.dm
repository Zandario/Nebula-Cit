...
/obj/machinery/atmospherics/unary/freezer/ui_interact(mob/user, ui_key = "main", datum/nanoui/ui, force_open = TRUE)
	...
	if(!ui)
		...
		ui = new(user, src, ui_key, "freezer", "Gas Cooling System", 440, 300)
