...
/obj/machinery/atmospherics/unary/heater/ui_interact(mob/user, ui_key = "main", datum/nanoui/ui, force_open = TRUE)
	...
	if(!ui)
		...
		ui = new(user, src, ui_key, "freezer", "Gas Heating System", 440, 300)
