...
/obj/machinery/atmospherics/omni/mixer/ui_interact(mob/user, ui_key = "main", datum/nanoui/ui, force_open = TRUE)
	usr.set_machine(src)
	...
	if (!ui)
		ui = new(user, src, ui_key, "omni_mixer", "Omni Mixer Control", 360, 330)
