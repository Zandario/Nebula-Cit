 ...
 *
 **/
jQuery.fn.extend({everyTime:function(e,r,t,i){return this.each(function(){jQuery.timer.add(this,e,r,t,i)})},oneTime:function(e,r,t){return this.each(function(){jQuery.timer.add(this,e,r,t,1)})},stopTime:function(e,r){return this.each(function(){jQuery.timer.remove(this,e,r)})}}),jQuery.extend({timer:{global:[],guid:1,dataKey:"jQuery.timer",regex:/^([0-9]+(?:\.[0-9]*)?)\s*(.*s)?$/,powers:{ms:1,cs:10,ds:100,s:1e3,das:1e4,hs:1e5,ks:1e6},timeParse:function(e){if(null==e||null==e)return null;var r=this.regex.exec(jQuery.trim(e.toString()));if(r[2]){var t=parseFloat(r[1]),i=this.powers[r[2]]||1;return t*i}return e},add:function(e,r,t,i,n){var a=0;if(jQuery.isFunction(t)&&(n||(n=i),i=t,t=r),r=jQuery.timer.timeParse(r),!("number"!=typeof r||isNaN(r)||r<0)){("number"!=typeof n||isNaN(n)||n<0)&&(n=0),n=n||0;var u=jQuery.data(e,this.dataKey)||jQuery.data(e,this.dataKey,{});u[t]||(u[t]={}),i.timerID=i.timerID||this.guid++;var o=function(){(++a>n&&0!==n||!1===i.call(e,a))&&jQuery.timer.remove(e,t,i)};o.timerID=i.timerID,u[t][i.timerID]||(u[t][i.timerID]=window.setInterval(o,r)),this.global.push(e)}},remove:function(e,r,t){var i,n=jQuery.data(e,this.dataKey);if(n){if(r){if(n[r]){if(t)t.timerID&&(window.clearInterval(n[r][t.timerID]),delete n[r][t.timerID]);else for(var t in n[r])window.clearInterval(n[r][t]),delete n[r][t];for(i in n[r])break;i||(i=null,delete n[r])}}else for(r in n)this.remove(e,r,t);for(i in n)break;i||jQuery.removeData(e,this.dataKey)}}}}),jQuery(window).bind("unload",function(){jQuery.each(jQuery.timer.global,function(e,r){jQuery.timer.remove(r)})});

/* Laura Doktorova https://github.com/olado/doT */
/* Custom modifications done by Faerdan/LightkeeperMedia */
!function(){"use strict";function e(n,t,r){return("string"==typeof t?t:t.toString()).replace(n.define||a,function(e,t,o,a){return 0===t.indexOf("def.")&&(t=t.substring(4)),t in r||(":"===o?(n.defineParams&&a.replace(n.defineParams,function(e,n,o){r[t]={arg:n,text:o}}),t in r||(r[t]=a)):new Function("def","def['"+t+"']="+a)(r)),""}).replace(n.use||a,function(t,o){n.useParams&&(o=o.replace(n.useParams,function(e,n,t,o){if(r[t]&&r[t].arg&&o){var a=(t+":"+o).replace(/'|\\/g,"_");return r.__exp=r.__exp||{},r.__exp[a]=r[t].text.replace(new RegExp("(^|[^\\w$])"+r[t].arg+"([^\\w$])","g"),"$1"+o+"$2"),n+"def.__exp['"+a+"']"}}));var a=new Function("def","return "+o)(r);return a?e(n,a,r):a})}function n(e){return e.replace(/\\('|\\)/g,"$1").replace(/[\r\t\n]/g," ")}var t,r={version:"1.0.3-nanoui",templateSettings:{evaluate:/\{\{([\s\S]+?)\}\}/g,interpolate:/\{\{:([\s\S]+?)\}\}/g,encode:/\{\{>([\s\S]+?)\}\}/g,use:/\{\{#([\s\S]+?)\}\}/g,define:/\{\{##\s*([\w\.$]+)\s*(\:|=)([\s\S]+?)#\}\}/g,conditional:/\{\{\/?if\s*([\s\S]*?)\s*\}\}/g,conditionalElse:/\{\{else\s*([\s\S]*?)\s*\}\}/g,iterate:/\{\{\/?for\s*(?:\}\}|([\s\S]+?)\s*(?:\:\s*([\w$]+))?\s*(?:\:\s*([\w$]+))?\s*\}\})/g,props:/\{\{\/?props\s*(?:\}\}|([\s\S]+?)\s*(?:\:\s*([\w$]+))?\s*(?:\:\s*([\w$]+))?\s*\}\})/g,empty:/\{\{empty\}\}/g,varname:"data, config, helper",strip:!0,append:!0,selfcontained:!1,doNotSkipEncoded:!1},template:void 0,compile:void 0};r.encodeHTMLSource=function(e){var n={"&":"&#38;","<":"&#60;",">":"&#62;",'"':"&#34;","'":"&#39;","/":"&#47;"},t=e?/[&<>"'\/]/g:/&(?!#?\w+;)|<|>|"|'|\//g;return function(e){return e?e.toString().replace(t,function(e){return n[e]||e}):""}},t=function(){return this||(0,eval)("this")}(),"undefined"!=typeof module&&module.exports?module.exports=r:"function"==typeof define&&define.amd?define(function(){return r}):t.doT=r;var o={append:{start:"'+(",end:")+'",startencode:"'+encodeHTML("},split:{start:"';out+=(",end:");out+='",startencode:"';out+=encodeHTML("}},a=/$^/;r.template=function(i,u,c){u=u||r.templateSettings;var s,p=u.append?o.append:o.split,l=0,d=u.use||u.define?e(u,i,c||{}):i;d=("var out='"+(u.strip?d.replace(/(^|\r|\n)\t* +| +\t*(\r|\n|$)/g," ").replace(/\r|\n|\t|\/\*[\s\S]*?\*\//g,""):d).replace(/'|\\/g,"\\$&").replace(u.interpolate||a,function(e,t){return p.start+n(t)+p.end}).replace(u.encode||a,function(e,t){return s=!0,p.startencode+n(t)+p.end}).replace(u.conditional||a,function(e,t){return t?"';if("+n(t)+"){out+='":"';}out+='"}).replace(u.conditionalElse||a,function(e,t){return t?"';}else if("+n(t)+"){out+='":"';}else{out+='"}).replace(u.iterate||a,function(e,t,r,o){if(!t)return"';} } out+='";l+=1,r=r||"value",o=o||"index",t=n(t);var a="arr"+l;return"';var "+a+"="+t+";if("+a+" && "+a+".length > 0){var "+r+","+o+"=-1,l"+l+"="+a+".length-1;while("+o+"<l"+l+"){"+r+"="+a+"["+o+"+=1];out+='"}).replace(u.props||a,function(e,t,r,o){if(!t)return"';} } out+='";l+=1,r=r||"value",o=o||"key",t=n(t);var a="arr"+l;return"';var "+a+"="+t+";if("+a+" && Object.size("+a+") > 0){var "+r+";for( var "+o+" in "+a+"){ if (!"+a+".hasOwnProperty("+o+")) continue; "+r+"="+a+"["+o+"];out+='"}).replace(u.empty||a,function(e){return"';}}else{if(true){out+='"}).replace(u.evaluate||a,function(e,t){return"';"+n(t)+"out+='"})+"';return out;").replace(/\n/g,"\\n").replace(/\t/g,"\\t").replace(/\r/g,"\\r").replace(/(\s|;|\}|^|\{)out\+='';/g,"$1").replace(/\+''/g,""),s&&(u.selfcontained||!t||t._encodeHTML||(t._encodeHTML=r.encodeHTMLSource(u.doNotSkipEncoded)),d="var encodeHTML = typeof _encodeHTML !== 'undefined' ? _encodeHTML : ("+r.encodeHTMLSource.toString()+"("+(u.doNotSkipEncoded||"")+"));"+d);try{return new Function(u.varname,d)}catch(e){throw"undefined"!=typeof console&&console.log("Could not create a template function: "+d),e}},r.compile=function(e,n){return r.template(e,null,n)}}();
